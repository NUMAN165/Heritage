...
const PatnaPage = () => {
  ...
  const quickInfo = [
    {
      ...
      detail: "Patna Museum, Ashok Rajpath, Patna",
    },
    // {
    //   icon: "🕒",
    //   title: "Timings",
  ...
  // Travel info
  const travelInfo = [
    { icon: "✈️", title: "Nearest Airport", value: "Patna Airport (7 km)" },
    {
      icon: "🚂",
      title: "Nearest Railway",
      value: "Patna Railway Station",
    },
  ...
  const nearbyAttractions = [
    { name: "Golghar", distance: "2.5 km", rating: "4.5★" },
    { name: "Patna Museum", distance: "1.5 km", rating: "4.2★" },
    { name: "Buddha Smriti Park", distance: "6 km", rating: "4.3★" },
      ...
      <section className="hero-section">
        <div className="hero-image-container">
          ...
          <div className="hero-content">
            <h1 className="monument-title">Patna Museums</h1>
            <p className="monument-tagline">A Journey Through History</p>
        ...
        >
          ...
          >
            ...
            <div className="virtual-tour-info">
              <p>🌟 Explore Patna Museum in stunning 360° detail</p>
